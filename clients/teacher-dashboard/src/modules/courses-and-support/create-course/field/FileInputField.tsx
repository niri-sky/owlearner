...
function FileInputField({
  ...
  const labelStyle =
    "font-semibold text-[14px]  flex items-center gap-3 leading-[19.07px]  text-[#101010] mb-[10px] inline-block";
  const inputStyle =
    "outline-[#E0E0E0] w-[100%] focus:outline-none h-[48px] text-[#6D6D6D] bg-[#F8F8F8] text-[14px] font-medium border border-[#E0E0E0] rounded-[6px]  px-[20px] py-3 ";

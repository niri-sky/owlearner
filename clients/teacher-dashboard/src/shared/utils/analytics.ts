...
export const calculateLast8MonthsEarnings = (sales: AnalyticsSales[]) => {
  ...
  for (let i = 0; i < 8; i++) {
    ...
    last8MonthsEarnings.unshift({
      ...
      value: Number(earningsOfMonth.toFixed(2)),
    });
  }
...
export const calculateCurrentAndPrevious = (sales: AnalyticsSales[]) => {
  ...
  console.log(currentMonthEarnings, previousMonthEarnings, "Monthly Earnings");

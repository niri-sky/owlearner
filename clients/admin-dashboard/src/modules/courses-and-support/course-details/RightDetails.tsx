...
import CourseApproveModal from "../courses/CourseApproveModal";
import CourseDeclineModal from "../courses/CoursesDeclineModal";
  ...
  return (
    <div className="right-section lg:w-[424px]">
      <div className="bg-[#fff] border border-[#E9EAF0] shadow-[0px_6px_16px_0px_#0000000F]">
        ...
        <div className=" p-3 md:p-6 flex flex-col gap-3">
          {(data?.status == "pending" || data?.status == "declined") && (
            <button
              onClick={approveModalChange}
              className="h-[56px] bg-[#C713CB] text-[#fff] w-full font-bold font-dmsans text-lg leading-[56px] tracking-[-0.18px] capitalize"
            >
              Approved
            </button>
          )}
          ...
          {/* <button className="h-[56px] bg-[#C713CB14] text-[#C713CB] w-full font-bold font-dmsans text-lg leading-[56px] tracking-[-0.18px] capitalize">
            Buy Now
          </button> */}
      ...
      <Modal isOpen={declineModal} onOpenChange={declineModalChange}>
        <CourseDeclineModal data={data as any} />
      </Modal>
      <Modal isOpen={approveModal} onOpenChange={approveModalChange}>
        <CourseApproveModal data={data as any} />
      </Modal>
    </div>
  );
}

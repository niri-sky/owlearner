...
const OneFingerSign = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    strokeWidth={0}
    aria-hidden="true"
    className="h-3 w-3 flex-shrink-0 self-center text-violet-600 dark:text-sky-500"
    viewBox="0 0 16 16"
    {...props}
  >
    <path

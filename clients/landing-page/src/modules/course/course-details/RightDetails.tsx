        ...
        <div className=" p-3 md:p-6 flex flex-col gap-3">
          {isAlreadyPurchased ? (
            <Link href={"/course-access/" + data?.slug}>
              <button className="h-[56px] bg-[#C713CB] text-[#fff] w-full font-bold font-dmsans text-lg leading-[56px] tracking-[-0.18px] capitalize">
                Go To Course
              </button>
            </Link>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={cn(
                ...
                isExistOnWishlist(data?.slug) && "bg-[#C713CB14] text-[#C713CB]"
              )}
            >

...
import { ORGANIZATION_SIGNUP, TEACHER_SIGNUP } from "@/graphql/queries";
...
const Signup: React.FC = () => {
  const [organizationSignup] = useMutation(ORGANIZATION_SIGNUP);
    ...
    try {
      ...
      router.push(
        "/signup/verify/" +
          ...
          "/" +
          result?.data?.signupOrganization?.token
      );

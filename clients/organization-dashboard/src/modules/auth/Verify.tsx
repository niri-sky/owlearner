...
import { ORGANIZATION_VERIFY, RESEND_ORGANIZATION_VERIFY, TEACHER_VERIFY } from "@/graphql/queries";
...
const VerifyPage: React.FC = () => {
  const [verifyTeacher] = useMutation(ORGANIZATION_VERIFY);
  const [resendOrganizationVerify] = useMutation(RESEND_ORGANIZATION_VERIFY)
  ...
  const handleResendEmail = ()=>{
    ...
    resendOrganizationVerify({variables:{
      token:params.token
    }})
